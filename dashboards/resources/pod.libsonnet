    ...
    'k8s-resources-pod.json':
      ...
      .addRow(
        ...
        .addPanel(
          ...
          g.queryPanel('sum(irate(container_network_receive_bytes_total{namespace=~"$namespace", pod=~"$pod"}[$__range])) by (pod)', '{{pod}}') +
          g.stack +
      ...
      .addRow(
        ...
        .addPanel(
          ...
          g.queryPanel('sum(irate(container_network_transmit_bytes_total{namespace=~"$namespace", pod=~"$pod"}[$__range])) by (pod)', '{{pod}}') +
          g.stack +
          { yaxes: g.yaxes('Bps'), interval: $._config.grafanaK8s.minimumTimeInterval },
        )
      )
      .addRow(
        ...
        .addPanel(
          ...
          g.queryPanel('sum(irate(container_network_receive_packets_total{namespace=~"$namespace", pod=~"$pod"}[$__range])) by (pod)', '{{pod}}') +
          g.stack +
          { yaxes: g.yaxes('Bps'), interval: $._config.grafanaK8s.minimumTimeInterval },
        )
      )
      .addRow(
        ...
        .addPanel(
          ...
          g.queryPanel('sum(irate(container_network_transmit_packets_total{namespace=~"$namespace", pod=~"$pod"}[$__range])) by (pod)', '{{pod}}') +
          g.stack +
          { yaxes: g.yaxes('Bps'), interval: $._config.grafanaK8s.minimumTimeInterval },
        )
      )
      .addRow(
        ...
        .addPanel(
          ...
          g.queryPanel('sum(irate(container_network_receive_packets_dropped_total{namespace=~"$namespace", pod=~"$pod"}[$__range])) by (pod)', '{{pod}}') +
          g.stack +
          { yaxes: g.yaxes('Bps'), interval: $._config.grafanaK8s.minimumTimeInterval },
        )
      )
      .addRow(
        ...
        .addPanel(
          ...
          g.queryPanel('sum(irate(container_network_transmit_packets_dropped_total{namespace=~"$namespace", pod=~"$pod"}[$__range])) by (pod)', '{{pod}}') +
          g.stack +
          { yaxes: g.yaxes('Bps'), interval: $._config.grafanaK8s.minimumTimeInterval },
        )
